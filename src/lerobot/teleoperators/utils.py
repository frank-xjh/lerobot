...
def make_teleoperator_from_config(config: TeleoperatorConfig) -> "Teleoperator":
    ...
    elif config.type == "terminal_keyboard_ee":
        from .keyboard.teleop_keyboard import TerminalKeyboardEndEffectorTeleop

        return TerminalKeyboardEndEffectorTeleop(config)
